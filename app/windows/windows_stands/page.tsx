...
import { furnitureData } from '@/component/Lists/windows/windows_stands';
...
export default function WindowsStandsPage() {
      ...
      <div className={styles.mainContainer} style={{ marginTop: '100px' }}>
        ...
        <div className={styles.grid}>
          {currentItems.map((item: FurnitureItem) => (
            <Link key={item.id} href={`/windows/windows_stands/${item.id}`} className={styles.card} style={{ textDecoration: 'none', color: 'inherit' }}>
