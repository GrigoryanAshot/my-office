...
import { furnitureData } from '@/component/Lists/other/metal_podium';
...
export default function MetalPodiumPage() {
  ...
  return (
    <>
      ...
      <div className={styles.mainContainer} style={{ marginTop: '100px' }}>
        <h1 className={styles.description1}>Դասախոսական ամբիոններ</h1>
        ...
        <div className={styles.grid}>
          {currentItems.map((item: FurnitureItem) => (
            <Link key={item.id} href={`/other/metal_podium/${item.id}`} className={styles.card} style={{ textDecoration: 'none', color: 'inherit' }}>
