...
import { furnitureData } from '@/component/Lists/other/hangers';
...
export default function MetalHangersPage() {
      ...
      <div className={styles.mainContainer} style={{ marginTop: '100px' }}>
        ...
        <div className={styles.grid}>
          {currentItems.map((item: FurnitureItem) => (
            <Link key={item.id} href={`/other/metal_hangers/${item.id}`} className={styles.card} style={{ textDecoration: 'none', color: 'inherit' }}>
