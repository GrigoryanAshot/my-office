...
interface ArmchairsPageClientProps {
  initialItems: ProductData[];
}

export default function ArmchairsPageClient({ initialItems }: ArmchairsPageClientProps) {
      ...
      <div className={styles.mainContainer} style={{ marginTop: '100px' }}>
        ...
        <div className={styles.grid}>
          {currentItems.map((item: ProductData) => (
            <Link key={item.id} href={`/softfurniture/armchairs/${item.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
