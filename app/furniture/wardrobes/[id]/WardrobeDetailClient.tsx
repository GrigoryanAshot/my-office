...
interface WardrobeDetailClientProps {
  item: ProductData;
}

export default function WardrobeDetailClient({ item }: WardrobeDetailClientProps) {
        ...
        <div className={styles.container}>
          ...
          <div className={styles.detailsSection}>
            ...
            <div className={styles.type}>
              Տեսակ: {typeof item.type === 'object' && item.type !== null && 'name' in item.type ? (item.type as { name: string }).name : item.type || 'N/A'}
            </div>
