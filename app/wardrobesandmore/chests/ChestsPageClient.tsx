...
export default function ChestsPageClient({ initialItems }: ChestsPageClientProps) {
      ...
      <div className={styles.mainContainer} style={{ marginTop: '100px' }}>
        ...
        <div className={styles.grid}>
          {currentItems.map((item) => (
            <Link key={item.id} href={`/wardrobesandmore/chests/${item.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
